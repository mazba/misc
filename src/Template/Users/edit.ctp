                        ...
                        <div class="tab-pane active" id="tab_5_1">
                            <div class="row whiteWrapper basicWrapper">
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    echo $this->Form->input('user_basic.date_of_birth',['value'=>isset($user['user_basic']['date_of_birth'])?date('d-m-Y', $user['user_basic']['date_of_birth']):'','class'=>'form-control datepicker','type'=>'text']);
