                        ...
                        <div class="tab-pane active" id="tab_5_1">
                            <div class="row whiteWrapper basicWrapper">
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    echo $this->Form->input('user_basic.date_of_birth', ['value' => $user['user_basic']['date_of_birth'] ? date('d-m-Y', $user['user_basic']['date_of_birth']) : '', 'class' => 'form-control datepicker', 'type' => 'text']);
                                    ...
                                    echo $this->Form->input('user_basic.is_married', ['type' => 'checkbox', 'class' => 'form-control married', 'label' => __('Is Married'), $user['user_basic']['spouse_name_bn'] ? 'checked' : '']);
                                    echo $this->Form->input('user_basic.spouse_name_bn', ['class' => 'for_married form-control', 'readonly' => !$user['user_basic']['spouse_name_bn'] ? 'readonly' : '', 'label' => __('Spouse Name Bn')]);
                                    echo $this->Form->input('user_basic.spouse_name_en', ['class' => 'for_married form-control', 'readonly' => !$user['user_basic']['spouse_name_en'] ? 'readonly' : '', 'label' => __('Spouse Name En')]);
                            ...
                            <div class="row ">
                                <div class="designationWrapper">
                                    ...
                                    <div class="col-md-12 designation">
                                        ...
                                        <div class="col-md-6">
                                            <input type="hidden" name="user_designations[0][id]"
                                                   value="<?= $user['user_designations'][0]['id']; ?>"/>
                                            ...
                                            echo $this->Form->input('user_designations.0.starting_date', ['value' => $user['user_designations'][0]['starting_date'] ? date('d-m-Y', $user['user_designations'][0]['starting_date']) : '', 'type' => 'text', 'class' => 'form-control datepicker', 'label' => __('Starting Date')]);
                                            echo $this->Form->input('user_designations.0.ending_date', ['value' => $user['user_designations'][0]['ending_date'] ? date('d-m-Y', $user['user_designations'][0]['ending_date']) : '', 'type' => 'text', 'class' => 'form-control datepicker', 'label' => __('Ending Date')]);
                                    ...
                                    <?php
                                    if (count($user['user_designations']) > 1) {
                                        for ($i = 1; $i < count($user['user_designations']); $i++) {
                                            ?>


                                            <div class="col-md-12 single_list_designation list_designation"
                                                 data-index_no="<?= count($user['user_designations']) - 1; ?>">
                                                <h3>Unit Designation</h3>
                                                <hr/>
                                                <div class="form-group "><span
                                                        class="btn btn-sm btn-circle btn-danger remove pull-right"><i
                                                            class="fa fa-close"></i></span></div>
                                                <div class="col-md-6">

                                                    <input type="hidden" name="user_designations[<?= $i ?>][id]"
                                                           value="<?= $user['user_designations'][$i]['id']; ?>"/>

                                                    <?php
                                                    echo $this->Form->input('user_designations.' . $i . '.office_unit_id', ['value' => $user['user_designations'][$i]['office_unit_id'], 'options' => $OfficeUnits, 'empty' => 'Select', 'class' => 'form-control office_unit_id', 'label' => __('Office Unit')]);
                                                    echo $this->Form->input('user_designations.' . $i . '.designation_id', ['value' => $user['user_designations'][$i]['designation_id'], 'options' => $Unit_designations, 'empty' => 'Select', 'class' => 'form-control office_unit_designation_id', 'label' => __('Office Unit Designation')]);

                                                    ?>
                                                </div>
                                                <div class="col-md-6">
                                                    <?php
                                                    echo $this->Form->input('user_designations.' . $i . '.designation_order', ['value' => $user['user_designations'][$i]['designation_order'], 'type' => 'text', 'options' => [], 'empty' => 'Select', 'class' => 'form-control', 'label' => __('Designation Order')]);

                                                    echo $this->Form->input('user_designations.' . $i . '.starting_date', ['value' => $user['user_designations'][$i]['starting_date'] ? date('d-m-Y', $user['user_designations'][$i]['starting_date']) : '', 'type' => 'text', 'class' => 'form-control datepicker', 'label' => __('Starting Date')]);
                                                    echo $this->Form->input('user_designations.' . $i . '.ending_date', ['value' => $user['user_designations'][$i]['ending_date'] ? date('d-m-Y', $user['user_designations'][$i]['ending_date']) : '', 'type' => 'text', 'class' => 'form-control datepicker', 'label' => __('Ending Date')]);
                                                    ?>
                                                </div>
                                            </div>
                                        <?php }
                        ...
                        <div class="tab-pane" id="tab_5_9">
                            <div class="row whiteWrapper loginWrapper">
                                <div class="col-md-6 col-md-offset-2">
                                    ...
                                    echo $this->Form->input('update_password', ['class' => 'form-control', 'label' => __('Password')]);
